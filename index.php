...
<head>
	...
	<title>Henderson Cleaning Services</title>
	...
	<link href="https://fonts.googleapis.com/css?family=Lato:400,700|Palanquin:100,400,700" rel="stylesheet">
	...
	<div class="container-fluid" id="bar-main">
		...
		<div class="hero-content">
			<div class="h2-container">
				<h2>Cleaning is our business</h2>
				<h5>Cleaners in <strong>New England</strong></h5></div>



			<a href="#callcontain" role="button" class="btn outline2">REQUEST QUOTE</a>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="services-column">
					...
					<div class="rss">
<p class="services-text">We’re passionate about fixing home problems. Take a look at the services we provide:</p>

						<ul>
							<li>
								<p class="service-item" id="serv1">Professional Staff</p>
							</li>
							<li>
								<p class="service-item" id="serv2">Best Cleaning Supplies</p>
							...
							<li>
								...
								<p class="service-item" id="serv3">Tailored for your Budget</p>

							</li>
							<li>

								<p class="service-item" id="serv4">Fast and Efficient</p>

							</li>
							<li>
								<p class="service-item" id="serv5">1 on 1 Customer Care</p>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-12 text-center">
					<p>
						Copyright Henderson Cleaning Services 2017 | Made with <a href="http://www.vylocal.com">VY Local</a></p>
				</div>
			</div>
		</div>
